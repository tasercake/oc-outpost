...
- `notes/` — thematic notes (architecture patterns, eval strategies, etc.)
- `syntheses/` — cross-cutting analysis and recommendations
- `INDEX.md` — master index of all sources and status
